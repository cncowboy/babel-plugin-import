...
function () {
  function Plugin(libraryName, libraryDirectory, style, camel2DashComponentName, camel2UnderlineComponentName, fileName, customName, types) {
    ...
    if (typeof this.style === 'string' && (this.style.indexOf('function') >= 0 || this.style.indexOf('=>') > 0)) {
    ...
    if (typeof this.customName === 'string' && (this.customName.indexOf('function') >= 0 || this.customName.indexOf('=>') > 0)) {
